...
## Statement of Research and Intereset

- We as a team want to implement the techniques of statistical analysis we learnt in this course and implement to the housing data. With current house prices being all time high it would be nice if we can build something that helps analyze current market trend and help predict the value if houses that are in the market.

- The project will also help us explore some coding techniques and packagers that are available for processes like data exploration, profiling and manipulation in `R`. We would like to understand the different tools and techniques we can use in `R` for model building.
